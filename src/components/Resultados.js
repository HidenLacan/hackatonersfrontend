  ...
  return (
    <section className="results py-8" id="results">
      <div className="container mx-auto px-4  ">
        <h2 data-aos="fade-up" data-aos-duration="2000" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold  mb-20 text-center">Reto</h2>
        ...
        <div data-aos="fade-up" data-aos-duration="2000" className=" ">
          <h2 data-aos="fade-up" data-aos-duration="2000" className="text-6xl center font-bold mt-10 mb-10 text-center">Resultados</h2>
