...
const Resultados = () => {
  ...
  return (
    <section className="results py-8" id="results">
      ...
      <h2 data-aos="fade-up" data-aos-duration="2000" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold  mb-20 text-center  bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-violet-500">Retoo</h2>
        ...
        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.6 }}>
          <div className="relative bg-white border shadow-sm rounded-xl ">
            <img className="w-full h-auto rounded-xl " src="https://images.unsplash.com/photo-1676430535237-54da81604421?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwcm9maWxlLXBhZ2V8MjB8fHxlbnwwfHx8fHw%3D" alt="Image Description" />
            <div className="absolute top-0 left-0 right-0  p-4 md:p-5" data-aos="fade-up" data-aos-duration="2000">
              ...
              <p className="mt-1 text-sm sm:text-base md:text-lg lg:text-2xl text-white">
                El Retail Challenge de Triple Ten propone un reto para identificar tendencias de compradores en Europa, con el objetivo de determinar los posibles leads de ventas. Esto permitirá generar diversas estrategias de ventas que traduzcan los datos en acciones empresariales concretas. Durante este reto, se proporcionarán datos de una empresa confidencial para desarrollar estrategias segmentadas.
              </p>
            </div>
          </div>
        </motion.div>
        <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.6 }}>
          <div className="relative bg-white border shadow-sm rounded-xl">
            <img className="w-full h-auto rounded-xl bg-black bg-opacity-50" src="https://images.unsplash.com/photo-1676430535246-16f7de3560b0?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwcm9maWxlLXBhZ2V8MTh8fHxlbnwwfHx8fHw%3D" alt="Image Description" />
            <div className="absolute top-0 left-0 right-0  p-4 md:p-5" data-aos="fade-up" data-aos-duration="2000">
              <h3 className="text-xl sm:text-3xl md:text-3xl lg:text-4xl font-bold mb-4 text-white">Objetivo</h3>
              <p className="mt-1 text-sm sm:text-base md:text-lg  lg:text-2xl text-white">
                Realizar un análisis estadístico utilizando procedimientos como el análisis de datasets, la estadística descriptiva, la segmentación, la predicción, el clustering y la visualización de datos para llevar a cabo una segmentación de clientes, con el fin de generar leads de ventas.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        <div data-aos="fade-up" data-aos-duration="2000" className=" ">
          <h2 data-aos="fade-up" data-aos-duration="2000" className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold  mb-20 text-center  bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-violet-500">Resultados</h2>
