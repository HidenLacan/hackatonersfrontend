...
const Header = () => {
  return (
    <header className="header">
      <img data-aos="fade-up" data-aos-duration="2000" src={logo} alt="Aqui esta el logo" className="nav__logo"/>
      <nav className="nav">
      ...
      <h1  data-aos="fade-up" data-aos-duration="2000" className="header__title">
